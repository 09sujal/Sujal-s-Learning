...
def one():
    print("""\n
    This program solicits user input and categorizes it based on whether it represents 
    an uppercase letter, a lowercase letter, or neither. 
    It prints '1' if the input is an upperrcase letter, '0' if it is a lowercase letter,
    and '-1' if it does not fall into either category.
...
def three():
    def gl(a,b):
        if -10**5 <= a <= 10**5 and -10**5 <= b <= 10**5:
            ...
            return "Numbers are not within the valid range."
...
def four():
    ...
    if choice == 1:
            ...
            return areaSwitchCase(choice, [radius])
    elif choice == 2:
            print("\nFor rectangle enter Length and breadth.\n")
            length = float(input("Enter the length of the rectangle: "))
            breadth = float(input("Enter the breadth of the rectangle: "))
            print( "Area of rectangle is"); return areaSwitchCase(choice, [length, breadth])
    else:
...
def six():
    def iter(n):
        ...
        if n==0:
            ...
            return cur
    print("\nThis program will return Fibonacci number of given position.\nEnter Position.\n")    
    n = int(input())
    z = iter(n) 
    print(z)
...
def seven():
    print("""
    This program takes input for an integer 'n' and print the sum of all its even digits 
...
def eight():
    print("\nThis program will return max value and swap values based on input 1 or 2 respectively.\n")
    def maximum(a,b):
        return max(a,b)        
    def swaping(c,d):
        return d,c
